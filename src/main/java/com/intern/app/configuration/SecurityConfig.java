...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_ENDPOINTS = {"/api/profile/CreateProfile", "/api/authentication/Authenticate", "/api/authentication/IntroSpect", "/api/faculty/**", "/api/major/**"};
